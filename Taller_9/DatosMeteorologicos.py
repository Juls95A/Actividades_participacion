...
class DatosMeteorologicos:
    def __init__(self, nombre_archivo: str):
        """
        Inicializa la instancia de DatosMeteorologicos con el nombre del archivo.
        """
        self.nombre_archivo = nombre_archivo

    def procesar_datos(self) -> Tuple[float, float, float, float, str]:
        """
        Procesa los datos del archivo y devuelve estadísticas meteorológicas.
        """
        suma_temperatura = 0
        suma_humedad = 0
        suma_presion = 0
    ...
    def abreviacion_a_radianes(self, abreviacion: str) -> float:
        """
        dirección de viento a radianes
        """
...
if __name__ == "__main__":
    ARCHIVO_TEXTO = 'datos_meteorologicos.txt'
